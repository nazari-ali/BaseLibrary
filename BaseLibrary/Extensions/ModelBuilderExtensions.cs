...
namespace BaseLibrary.Extensions
{
    public static class ModelBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="modelBuilder"></param>
        public static void AddRestrictDeleteBehaviorConvention(
            this ModelBuilder modelBuilder
        )
        {
        ...
        public static void AddSequentialGuidForIdConvention(
            this ModelBuilder modelBuilder
        )
        {
        ...
        /// </summary>
        /// <param name="modelBuilder"></param>
        public static void AddSingularizingTableNameConvention(
            this ModelBuilder modelBuilder
        )
        {
            Pluralizer pluralizer = new Pluralizer();
