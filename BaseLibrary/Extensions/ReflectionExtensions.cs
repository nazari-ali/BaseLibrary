...
namespace BaseLibrary.Extensions
{
    public static class ReflectionExtensions
    {
        ...
        public static bool IsInheritFrom<T>(
            this Type type
        )
        {
        ...
        public static bool BaseTypeIsGeneric(
            this Type type,
            Type genericType
        )
        {
        ...
        public static IEnumerable<Type> GetTypesHasAttribute<T>(
            params Assembly[] assemblies
        )
            where T : Attribute
        {
        ...
        public static IEnumerable<Type> GetTypesHasAttribute(
            this Type type,
            params Assembly[] assemblies
        )
        {
        ...
        public static IEnumerable<Type> GetBaseTypesAndInterfaces(
            this Type type
        )
        {
        ...
        public static bool IsCustomValueType(
            this Type type
        )
        {
        ...
        public static bool IsCustomReferenceType(
            this Type type
        )
        {
            return !type.IsValueType && !type.IsPrimitive && type.Namespace != null && !type.Namespace.StartsWith("System", StringComparison.Ordinal);
